...
//.......................................The.frame.of.the.animation.are.drawn.inside.the.while.loop.
    public void run(){
        ...
        gameUpdate();
        //gameRender();
        //onDraw(dbg);//....................................................draw.the.buffer.onscrean
        this.postInvalidate();
...
//.................................................................................the required FPS.
    ...
    private void gameRender(){
        if (dbImage == null){
            ...
            dbImage = Bitmap.createBitmap(PWIDTH, PHEIGHT,conf);
            if (dbImage == null) {
                System.out.println("dbImage is null");
                return;
            }
            else dbg = new Canvas(dbImage);
        }
//...............................................draw.the.background:.use.the.image.or.a.black.color
        dbg.drawBitmap(imgres.getImage("background"), 0, 0, null);
        for (int i=0;i<24;i++){//......................................................render.joints
            generatedJoints.Joints[i].onDraw(dbg);
        }
        DraggablePoint.onDraw(dbg);
        Display.onDraw(dbg);
        if(GC.getGameOver()) dbg.drawBitmap(imgres.getImage("resumeok"),300-20,335,null);
        else dbg.drawBitmap(imgres.getImage("resumenop"),300-20,335,null);
    ...
    protected void onDraw(Canvas canvas){//...........use.active.rendering.to.put.the.buffered.image.on-screen
        ...
        try{
           ...
           /* if ((canvas != null) && (dbImage != null))
                canvas.drawBitmap(dbImage, 0, 0, null);
                //invalidate();*/
    ...
    //...............................................draw.the.background:.use.the.image.or.a.black.color
            ...
            if(GC.getGameOver()) canvas.drawBitmap(imgres.getImage("resumeok"),300-20,335,null);
            else canvas.drawBitmap(imgres.getImage("resumenop"),300-20,335,null);
            //Log.d(TAG, "render now");
            }
        catch (Exception e){ 
