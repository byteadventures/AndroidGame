...
//--------------------------------------------------------------------------------------------------
    ...
    public void onDraw(Canvas canvas) {
        this.Animator();
        canvas.drawCircle(posx+circledia/2,posy+circledia/2, circledia/2, this.paint);
        
        if ((player!=0)||(fadeout==1)) {
            if (isActive){ 
                //g.fillArc(posx,posy,circledia,circledia,0,360);
            	//Log.d(TAG, "CurrentImage:" +CurrentImage);
                canvas.drawBitmap(imageset[CurrentImage], posx+3, posy+3, null);
            }
        }
    ...
    private void Animator(){
        ...
        //Log.d(TAG, "frame current time:" +framecurrenttime);
